			...
			for K in (K_cpu,K_gpu,K_gpu_sparse, K_gblas)
				...
				if K == K_gblas
					...
					function compute_s2()
						...
						sigma_2 = intdivbyn_sigma(sigma_2_notbinary, integer_division_by_2);
					end
					...
					function compute_s3()
						...
						sigma_3 = floatdivbyn_sigma(sigma_3_notbinary, float_division_by_4)
						sigma_3 = intdivbyn_sigma(sigma_3, integer_division_by_1)
					end
...
function floatdivbyn_sigma(sigma, f_DIV)
	...
	INTDIV_BYN = GrB_UnaryOp()
	GrB_UnaryOp_new(INTDIV_BYN, f_DIV, GrB_FP64, GrB_FP64)
